...
public class Runner {
	...
	private static final String WEB_EXAMPLES_DIR = "vertxweb";
	private static final String WEB_EXAMPLES_JAVA_DIR = WEB_EXAMPLES_DIR + "/src/main/java/";
	
	private static final String WEB_EXAMPLES_JAVA_DIR2 = WEB_EXAMPLES_DIR + "/src/main/";
	...
	public static void runExample2(Class clazz) {
		runExample2(WEB_EXAMPLES_JAVA_DIR2, clazz, new VertxOptions().setClustered(false), null);
	}
	...
	public static void runExample2(String exampleDir, Class clazz, VertxOptions options, DeploymentOptions deploymentOptions) {
